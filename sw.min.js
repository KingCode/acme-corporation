(function(){const staticCacheName='static';const version='v1::';const OFFLINE_URL='https://kingcode.github.io/off/';function updateStaticCache(){const urls=['https://kingcode.github.io/','https://kingcode.github.io/manifest.json','/GitHubPages/css/index.min.8a93954c7c268b30868ca3260c4d48df8a863d3ade6e4f448d55c88bb24dc04cf3dd0b3d2b8a4c409d8d48e35e46798396f7f550062603f2ddc65abaa30c4d66.css','/GitHubPages/index.min.js','https://kingcode.github.io/GitHubPages/image/background.svg','https://kingcode.github.io/GitHubPages/image/background-dark_huacd336bfb7f5597695f9c32d4115a2aa_1561823_1400x787_fill_q75_box_smart1.jpg',OFFLINE_URL,'https://kingcode.github.io/GitHubPages/image/logo.min.svg','https://kingcode.github.io/index.json'];return caches.open(version+staticCacheName).then((cache)=>cache.addAll(urls)).catch(e=>{console.log("Error = ",e);console.log(e.stack);});}
