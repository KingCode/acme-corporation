(function(){const staticCacheName='static';const version='v1::';const OFFLINE_URL='https://kingcode.github.io/off/';function updateStaticCache(){const urls=['https://kingcode.github.io/','https://kingcode.github.io/manifest.json','/acme-corporation/css/index.min.6489d398943393a00d9c5da783c1d6e778cb3a6a64865dfb80830a47e46807537614b35cb4ba17047da9994974a1420b8a1930a157f28ae11e1be7593cdaf0a0.css','/acme-corporation/index.min.js','https://kingcode.github.io/acme-corporation/image/background.svg','https://kingcode.github.io/acme-corporation/image/background-dark_huacd336bfb7f5597695f9c32d4115a2aa_1561823_1400x787_fill_q75_box_smart1.jpg',OFFLINE_URL,'https://kingcode.github.io/acme-corporation/image/logo.min.svg','https://kingcode.github.io/index.json'];return caches.open(version+staticCacheName).then((cache)=>cache.addAll(urls)).catch(e=>{console.log("Error = ",e);console.log(e.stack);});}
